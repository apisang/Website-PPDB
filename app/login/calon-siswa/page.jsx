...
export default function CalonSiswaLoginPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#d9eeff] via-[#eaf4ff] to-[#caddff] text-[#16365f]">
      <div className="mx-auto flex max-w-6xl items-center justify-center px-6 py-12">
        <div className="w-full max-w-md space-y-8">
          <header className="text-center animate-fade-in-up">
            <div className="flex justify-center mb-6">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#1b3c69] to-[#0f305c] text-white shadow-lg">
                <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                </svg>
              </div>
            </div>
            <h1 className="text-3xl font-bold gradient-text animate-slide-in-left">Login Calon Siswa</h1>
          ...
          <div className="text-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <div className="rounded-2xl bg-white/90 p-6 shadow-lg backdrop-blur">
              <h3 className="text-lg font-semibold text-[#1a3763] mb-3">Butuh Bantuan?</h3>
              <p className="text-sm text-[#45628a] mb-4">
                Hubungi panitia PPDB untuk bantuan login atau informasi pendaftaran
              </p>
              <div className="flex flex-col gap-2 text-sm">
                <div className="flex items-center justify-center gap-2">
                  <svg className="h-4 w-4 text-[#1b3c69]" fill="currentColor" viewBox="0 0 24 24">
