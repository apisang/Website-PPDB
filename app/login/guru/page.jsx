      ...
      <div className="mx-auto flex max-w-6xl items-center justify-center px-6 py-8">
        <div className="w-full max-w-md space-y-6">
          <header className="text-center animate-fade-in-up">
            ...
            <h1 className="text-xl lg:text-2xl font-bold gradient-text animate-slide-in-left">Login Guru</h1>
            <p className="mt-3 text-sm lg:text-base text-[#46658f] animate-slide-in-right">
              Masuk ke akun Anda untuk mengakses Home Guru SMK Taruna Bhakti Depok
            </p>
          </header>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <LoginForm
              title="Masuk ke Home"
              description="Gunakan username dan password yang telah terdaftar untuk mengakses Home Guru."
              role="guru"
          ...
          <div className="text-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <div className="rounded-xl bg-white/90 p-4 lg:p-5 shadow-lg backdrop-blur">
              ...
              <p className="text-xs lg:text-sm text-[#45628a] mb-3">
                Hubungi administrator untuk bantuan login atau informasi akun
              </p>
